...
Zone1 <- c( 
  format(as.integer(accuracy(naive, yValid1.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(sn_model, yValid1.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(pc1_holt.forecast, yValid1.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(zone1.tslm.pred, yValid1.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(zone1.arima_predict.ts, yValid1.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(pc.1.nnetar.pred, yValid1.ts)[4]), scientific = FALSE))


Zone2 <- c( 
  format(as.integer(accuracy(naive, yValid2.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(sn_model, yValid2.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(pc2_holt.forecast, yValid2.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(zone2.tslm.pred, yValid2.ts)[4]), scientific = FALSE),
  format(as.integer(accuracy(zone2.arima_predict.ts, yValid2.ts)[4]), scientific = FALSE), 
  format(as.integer(accuracy(pc.2.nnetar.pred, yValid2.ts)[4]) , scientific = FALSE) )


Zone3 <- c( 
            format( as.integer(accuracy(naive, yValid3.ts)[4]), scientific = FALSE), 
            format( as.integer(accuracy(sn_model, yValid3.ts)[4]), scientific = FALSE), 
            format( as.integer(accuracy(pc3_holt.forecast, yValid3.ts)[4]), scientific = FALSE),
            format( as.integer(accuracy(zone3.tslm.pred, yValid3.ts)[4]), scientific = FALSE), 
            format( as.integer(accuracy(zone3.arima_predict.ts, yValid3.ts)[4]), scientific = FALSE), 
            format( as.integer(accuracy(pc.3.nnetar.pred, yValid3.ts)[4]), scientific = FALSE))

Models <- c("Naive", "Seasonal Naive", "Holt's Winter", "TSLM", "Arima", "Neural Network" )
